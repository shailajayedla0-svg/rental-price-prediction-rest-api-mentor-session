...
# Load the trained machine learning model from the local backend directory
MODEL_PATH = os.path.join(os.path.dirname(__file__), "rental_price_prediction_model_v1_0.joblib")
